  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center gap-4 mb-8 flex-wrap">
        {Object.keys(skillsData).map((category) => (
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm sm:text-lg font-medium transition ${activeTab === category
      ...
      <motion.ul
        ...
        className="flex flex-wrap justify-center gap-2 sm:gap-4 px-2 text-sm sm:text-lg text-gray-800 dark:text-white/80"
        initial="initial"
        animate="animate"
        whileInView="animate"
      ...
      >
        {skillsData[activeTab].map((skill, index) => (
          <motion.li
            className="bg-white borderBlack rounded-md px-3 py-2 sm:px-5 sm:py-3 dark:bg-white/10 dark:text-white/80 max-w-full"
            key={index}
